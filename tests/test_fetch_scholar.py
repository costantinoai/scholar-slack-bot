...
from scholar_slack_bot.scholar.fetch import (
    load_cache,
    save_updated_cache,
    get_pubs_to_fetch,
...
@patch("scholar_slack_bot.scholar.fetch.save_updated_cache")
@patch(
    "scholar_slack_bot.scholar.fetch.fetch_selected_pubs",
    return_value=[{"bib": {"title": "New", "pub_year": "2024"}}],
)
@patch(
    "scholar_slack_bot.scholar.fetch.get_pubs_to_fetch",
    return_value=[{"bib": {"title": "New", "pub_year": "2024"}}],
)
@patch(
    "scholar_slack_bot.scholar.fetch.load_cache",
    return_value=[{"bib": {"title": "Old", "pub_year": "2023"}}],
)
@patch(
    "scholar_slack_bot.scholar.fetch.fetch_author_details",
    return_value=[
        {"bib": {"title": "Old", "pub_year": "2023"}},
        {"bib": {"title": "New", "pub_year": "2024"}},
    ],
)
@patch("scholar_slack_bot.scholar.fetch.clean_pubs", return_value=["cleaned"])
...
@patch(
    "scholar_slack_bot.scholar.fetch.fetch_publications_by_id",
