...
from helper_funcs import has_conflicting_args 
from streams_funcs import test_fetch_and_message, refetch_and_update, add_scholar_and_fetch, regular_fetch_and_message
...
def get_args():
    ...
    parser.add_argument('--test_message', action='store_true', help='Send test message. Do not fetch (unless --test_fetching), or save cache.')
